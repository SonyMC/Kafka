...
public class OpenSearchConsumerPart2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Logger log = LoggerFactory.getLogger(OpenSearchConsumerPart2.class.getSimpleName());
        ...
        try (openSearchClient; consumer) {  // pass in the openSearchClient & Kafka consumer as arguments in the try block
            ...
            while (true) {
                ...
                for (ConsumerRecord<String, String> record : records) {
                    try {  // Putting in a try catch to skip th econcrete object exception which will happen otheewise
