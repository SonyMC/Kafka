...
public class ConsumerDemoCooperative {
    ...
    // Define the    Logger
    private static final Logger consumerLog = LoggerFactory.getLogger(ConsumerDemoCooperative.class.getSimpleName());
    ...
    public static void main(String[] args) {
        ...
        // Force the assignor to run only in cooperative sticky mode
        ...
        // If you want to use the static assignment of partitions to consumers, you can specify it as follows by giving a group insotace if for each of your consumer groups
        // consumerProperties.setProperty(ConsumerConfig.GROUP_INSTANCE_ID_CONFIG,"xxx");
        ...
        // Implementation of runnable functional interface for  a new Thread
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {  // run this thread when we shutdown our application
        ...
        try {
            ...
            while(true) {
                ...
                ConsumerRecords<String, String> records =
                        ...
                        // Note : This is where the 'WakeupException' is triggered as when it tries to wakeup as the application would be trying to shut down( we would be shutting the application manually)!!!
