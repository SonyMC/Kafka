...
# Windows
# 3. Open a terminal or text editor on the Kafka directory
# 4. Edit the file at config/connect-distributed.bat uaing your prefeered text editor
# D:\OneDrive\Study\DevOps\Kafka\Kafka Binary\kafka_2.13-3.3.1\bin\windows
