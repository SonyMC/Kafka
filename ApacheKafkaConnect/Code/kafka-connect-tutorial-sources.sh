...
# We start a hosted tools, mapped on our code directory
# Here we will be using teh bash tool to talk to our container
# Linux / Mac
...
docker run --rm -it -v ${PWD}:/Code --net=host landoop/fast-data-dev:cp3.3.0 bash
